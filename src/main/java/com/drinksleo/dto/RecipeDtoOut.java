...
public class RecipeDtoOut implements Serializable {
    ...
    @Schema(description = "This is the Drink`s imageUrl. The path is putted by the System", example = "C:\\Users\\PC\\OneDrive\\Estudo\\Programação\\Projetos\\drinksleo-front\\images\\drinks-images\\drink abacaxi com hortela.png")
